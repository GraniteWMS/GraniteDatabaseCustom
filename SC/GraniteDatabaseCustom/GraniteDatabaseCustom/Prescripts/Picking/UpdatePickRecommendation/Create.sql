...
DECLARE @UpdateComment varchar(MAX)
...
BEGIN
	...
	SELECT @UpdateComment = ISNULL('Pick from:' + (SELECT TOP 1  L.Barcode + ' - TE:' +  TE.Barcode
	...
	UPDATE DocumentDetail SET Comment = @UpdateComment
