...
-- =============================================
CREATE PROCEDURE [dbo].[Mail_TransactionsReceiving]
...
BEGIN
	...
	Declare @DocumentID BIGINT = (SELECT ID FROM [$(GraniteDatabase)].dbo.Document WHERE Number = @DocumentReference)
	...
	SELECT @EmailSubject = 'Purchase Order:' + @DocumentReference + ' Received by:' + @UserName + ' is Complete as below'												
